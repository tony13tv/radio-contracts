...
function Dashboard() {
    ...
    const toggleOne = () => {
        setState(state => ({
            ...state,
            dropdownOpenOne: !state.dropdownOpenOne,
        }));
    }
    ...
    const changeCheck = (event: React.ChangeEvent<HTMLInputElement>, checkbox: string, id: number) => {
        state[checkbox][id] = event.target.checked;
                                ...
                                <div className="d-flex flex-wrap align-items-center justify-content-center">
                                    <div className="d-flex flex-column align-items-center col-12 col-xl-6 p-sm-4">
                                        ...
                                        <div className="d-flex justify-content-between my-4">
                                            <Button size="sm" className="rounded-pill mr-1" color="primary">Go
                                                Premium</Button>
                                            <Button className="rounded-pill body-3" outline color="dark">Try for
                                                free</Button>
                                        </div>
                                    </div>
                ...
                <Col className="mt-4 mt-lg-0 pl-grid-col" xs={12} lg={4}>
                    <Widget className="widget-p-lg">
                        ...
                        <div className={`mt-3 ${s.widgetBlock}`}>
                            <div className={s.widgetBody}>
                                <div className="d-flex">
                                    <img className="img-fluid mr-2" src={gymIcon.src} alt="..."/>
                                    <div className="d-flex flex-column">
                                ...
                                <div className="checkbox checkbox-primary">
                                    <input
                                        ...
                                        onChange={(event) =>
                                            changeCheck(event, "checkboxes", 0)
                                        }
                                    />
