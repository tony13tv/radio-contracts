            ...
            <Row className="gutter mb-4">
                <Col xs={12} lg={4}>
                    <Widget className="widget-p-md">
                        ...
                        <div className={s.widgetText}>There are few position options available for notifications. You
                ...
                <Col xs={12} lg={4} className="mt-4 mt-lg-0">
                    <Widget className="widget-p-md">
                        ...
                        <div className={s.widgetText}>Different types of notifications for lots of use cases. Custom
