...
import s from "./tables.page.module.scss";
                            ...
                            <Widget>
                                <div className={s.tableTitle}>
                                    ...
                                    <div className="d-flex">
                                        ...
                                        <a href="/#"><img className="d-none d-sm-block" src={cloudIcon}
                                                          alt="Cloud"/></a>
                                        <a href="/#"><img src={printerIcon} alt="Printer"/></a>
                                        <a href="/#"><img className="d-none d-sm-block" src={optionsIcon}
                                                          alt="Options"/></a>
                                        ...
                                        {firstTable
                                            ...
                                            .map(item => (
                                                <tr key={uuidv4()}>
                                                    ...
                                                    <td className="d-flex align-items-center"><img className={s.image}
                                                                                                   src={item.img.src}
                                                                                                   alt="User"/><span
                                ...
                                <div className={s.widgetContentBlock}>
                                    {transactions.map(item => (
                                        <div key={uuidv4()} className={s.content}>
                                            <div><img src={item.icon} alt="Item"/><span
                                                className="body-2 ml-3">{item.category}</span></div>
