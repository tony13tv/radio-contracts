            ...
            <div>
                        ...
                        <Widget className="widget-p-lg">
                            <Row>
                                ...
                                <Col xs={12} xl={6} className="mt-5 mt-xl-0">
                                    ...
                                    <p className="body-3 text-muted">The goal of this new type was to create a sans
                                        serif font which give an impression of both modernism, harmony and roundness.
                                        These nuances give Sofia a harmonious and sensible appearance for both texts and
                                        headlines. </p>
                                    <p className="body-3 text-muted">This typeface is a complete redesign of Sofia
                                        initially designed in 2008. this typeface supports a wide range of languages
                                        with more than 500 glyphs. </p>
                                </Col>
                            </Row>
                        </Widget>
                    </Col>
                ...
                <Row>
                    <Col className="mb-4">
                        ...
                        >
                            <p className="mb-0">In ultricies fermentum aliquet. Pellentesque dui magna, condimentum non
                                ullamcorper at, cursus in sem. Nunc condimentum, purus ac sagittis ultricies, metus leo
                                pharetra mi, non vehicula felis elit et nisi. Etiam venenatis commodo libero, vel
                                ullamcorper nibh lobortis vel. Aliquam auctor porta tortor, nec consequat nibh finibus
                                a. Sed ultrices risus eget iaculis luctus. Mauris vel gravida magna.</p>
                        </Widget>
                    </Col>
                </Row>
                <Row>
